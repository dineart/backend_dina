...
docker compose -f docker-compose.prod.yml run --rm certbot certonly --webroot -w /var/www/certbot -d api-keuangan-4a.akufarish.my.id --email $EMAIL --agree-tos --no-eff-email
